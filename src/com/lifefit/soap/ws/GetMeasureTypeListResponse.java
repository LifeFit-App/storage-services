...
/**
 * <p>Java class for getMeasureTypeListResponse complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="measureTypes" type="{http://ws.soap.lifefit.com/}measure" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class GetMeasureTypeListResponse {
    ...
    protected List<Measure> measureTypes;
    ...
    public List<Measure> getMeasureTypes() {
        if (measureTypes == null) {
            measureTypes = new ArrayList<Measure>();
        }
